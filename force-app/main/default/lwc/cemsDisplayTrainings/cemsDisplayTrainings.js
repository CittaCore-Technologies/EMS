        ...
        getAllCEMSTrainings()
            ...
            .catch(error => {
                ...
                const event = new ShowToastEvent({
                    title: 'Error',
                    message: 'Error retrieving employee trainings',
                    variant: 'error',
                });
  ...
  loadEmployeeTrainings() {
    getAllCEMSTrainings()
      .then(result => {
        ...
        const certificateRecordTypeId = '012H4000000VCPUIA4'; // Replace with the actual Certificate Record Type Id
        const learningRecordTypeId = '012H4000000VCPVIA4'; // Replace with the actual Learning Record Type Id
